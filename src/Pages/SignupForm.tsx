...
const signupSchema = z.object({
  ...
  role: z.enum(["actor", "director"], { required_error: "Role is required" }),
});
...
export function SignupForm({
  ...
  useEffect(() => {
    // Sync role state with RHF value
  ...
  const onSubmit = (data: SignupFormData) => {
    const payload: RegisterData = {
      ...
      role: data.role, // ✅ include role in payload
    };
  ...
  return (
    <div
      className={cn(
        "min-h-screen pt-20 pb-10 px-4 flex items-start justify-center",
        className
      )}
      {...props}
    >
            ...
            <Field>
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  ...
                  className={cn(
                    "h-9",
                    role === "actor" ? "ring-1 ring-zinc-500" : ""
                  )}
                ...
                <Button
                  ...
                  className={cn(
                    "h-9",
                    role === "director" ? "ring-1 ring-zinc-500" : ""
                  )}
